...
#define cb_mk_list(name, type)                                                                  \
	...
	extern name *name##_insert_before(name l[restrict static 1], name *restrict to_insert); \
	extern name *name##_insert_after(name l[restrict static 1], name *restrict to_insert);  \
